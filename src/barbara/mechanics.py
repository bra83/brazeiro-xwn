...
from .resolution import ResolutionEnvelopeValidator
...
class MechanicsAuthority:
    ...
    def __init__(self,resolution_validator=None):
        self.resolution_validator=resolution_validator or ResolutionEnvelopeValidator()
    ...
    def validate_resolution(self,resolution):
        return self.resolution_validator.validate(resolution)
