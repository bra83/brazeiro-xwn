const CACHE='braseiro-xwn-wwn-v150';
const CORE=['./','./index.html','./styles.css','./app.js','./engine.js','./audioEngineV2.js','./rules-index.js','./hex-library.js','./manifest.webmanifest','./assets/app-icon.svg'];
